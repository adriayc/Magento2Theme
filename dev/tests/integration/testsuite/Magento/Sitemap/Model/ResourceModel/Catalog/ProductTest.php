...
class ProductTest extends \PHPUnit\Framework\TestCase
{
     ...
     * 1) Check that images attributes were not loaded
    ...
    public function testGetCollectionNone()
    {
        ...
        // Check that no images attributes were loaded
        foreach ($products as $product) {
            $this->assertEmpty($product->getName(), 'Attribute name is not empty');
            $this->assertEmpty($product->getImage(), 'Attribute images is not empty');
    ...
    public function testGetCollectionAll()
    {
        ...
        // Check no selection
        $this->assertEmpty($products[5]->getImage(), 'images is not empty');
    ...
    public function testGetCollectionBase()
    {
        ...
        // Check thumbnail attribute
        $this->assertEmpty($products[1]->getImage(), 'images attribute was loaded');
        $this->assertEmpty($products[4]->getThumbnail(), 'thumbnail attribute was loaded');
        $this->assertEquals('/s/e/second_image.png', $products[4]->getImage(), 'Incorrect images attribute');
        ...
        $this->assertEquals('no_selection', $products[5]->getImage(), 'images is incorrect');
