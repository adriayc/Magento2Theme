...
class AssertConfigurableProductImages extends AssertProductPage
{
    ...
    /**
     * Verify correct base images is shown.
     *
     * @return null|string
     */
    private function verifyBaseImage()
    {
        ...
        if ($this->areImagesDifferent($displayedImage, $data['images'][0]['file'])) {
            $message = 'Product images is not correct.';
        }
    ...
    protected function verifyOptionsImages()
    {
        ...
        foreach ($customOptions as $customOption) {
            ...
            if (in_array($displayedImage, $this->displayedImages)) {
                $message = 'Option images is not correct.';
                break;
            }
