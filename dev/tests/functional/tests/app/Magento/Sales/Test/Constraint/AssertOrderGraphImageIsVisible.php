...
/**
 * Assert order graph images is visible on admin dashboard.
 */
class AssertOrderGraphImageIsVisible extends AbstractConstraint
{
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertTrue(
            ...
            'Graph images is not visible on admin dashboard.'
        );
    }
    ...
    {
        return 'Order graph images is visible on the dashboard.';
    }
}
