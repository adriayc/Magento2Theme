...
class ImagesAndVideos extends Tab
{
     ...
     * @var string
     */
    protected $imageItem = '.images.item';
    ...
    {
        ++$id;
        return $this->imageItem . ':nth-child(' . $id . ') .product-images-wrapper';
    }

    /**
     * Returns emulated images index
     *
     * @return array
     */
