...
define([
    ...
    beforeEach(function (done) {
        injector.mock(mocks);
        injector.require(['Magento_Catalog/js/product/list/columns/images', 'knockoutjs/knockout-es5'],
            function (Constr) {
            obj = new Constr({
                sortable: true,
                sorting: false,
    ...
    describe('Magento_Catalog/js/product/list/columns/images', function () {
        var image = {
            url: 'url',
            width: 100,
            height: 100,
