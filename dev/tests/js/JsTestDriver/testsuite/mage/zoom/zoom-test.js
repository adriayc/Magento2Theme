...
ZoomTest.prototype.setUp = function() {
    /*:DOC +=
     ...
     <script data-template="zoom-enlarged-images" type="text/x-magento-template">
        <img data-role="enlarged-images" src="<%= data.img %>" />
     </script>
...
ZoomTest.prototype.testOnImageUpdated = function() {
    var zoomInstance = this.zoomCreate(),
        ...
        testImage = jQuery('<p data-role="test-images" />');

    zoomInstance.options.selectors.image = "[data-role=test-images]";
...
ZoomTest.prototype.testLargeImageLoaded = function() {
    var zoomInstance = this.zoomCreate(),
        ...
        image = jQuery('<p data-role="test-images" />');
...
ZoomTest.prototype.testRenderLargeImage = function() {
    ...
    zoomInstance.element.append(jQuery('<p data-role="test-images" />'));
    zoomInstance.options.selectors.image = '[data-role=test-images]';
