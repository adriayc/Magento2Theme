...
class ProductAttributeMediaGalleryManagementInterfaceTest extends \Magento\TestFramework\TestCase\WebapiAbstract
{
    ...
    /**
     * Retrieve target product images ID
     *
     * Target product must have single images if this function is used
     *
     * @return int
     */
    ...
    public function testCreate()
    {
        $requestData = [
            ...
            'content' => [
                ...
                ImageContentInterface::TYPE => 'images/jpeg',
        ...
        $this->assertEquals($updatedImage['file'], $targetProduct->getData('images'));
    }
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals('no_selection', $targetProduct->getData('images'));
     ...
     * @expectedExceptionMessage The images content must be valid base64 encoded data.
     */
     ...
     * @magentoApiDataFixture Magento/Catalog/_files/product_simple.php
     * @expectedException \Exception
     * @expectedExceptionMessage The images MIME type is not valid or not supported.
     */
     ...
     * @magentoApiDataFixture Magento/Catalog/_files/product_simple.php
     * @expectedException \Exception
     * @expectedExceptionMessage Provided images name contains forbidden characters.
     */
     ...
     * @magentoApiDataFixture Magento/Catalog/_files/product_with_image.php
     * @expectedException \Exception
     * @expectedExceptionMessage There is no images with provided ID.
     */
    ...
    public function testGet()
    {
        ...
        $expected = [
            ...
            'file' => $image['file'],
            'types' => ['images', 'small_image', 'thumbnail'],
        ];
    ...
    public function testGetList()
    {
        ...
        $this->assertContains('images', $imageTypes);
