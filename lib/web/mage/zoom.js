...
(function (root, factory) {
    ...
    $.widget('mage.zoom', {
        options: {
            ...
            selectors: {
                image: '[data-role=zoom-images]',
                imageContainer: '[data-role=gallery-base-images-container]',
        ...
        /**
         * Refresh zoom when images is updated
         * @protected
         */
        _onImageUpdated: function () {
            // Stop loader in case previous active images has not been loaded yet
        ...
        /**
         * Reset this.ratio when large images is loaded
         * @protected
         */
        ...
        /**
         * Refresh large images (refresh "src" and initial position)
         * @protected
         */
        ...
        _renderLargeImage: function () {
            ...
            // Start loader if 'load' event of images is expected to trigger later
            if (this.largeImageSrc) {
        ...
        /**
         * Refresh position of large images depending of position of zoom lens.
         *
    ...
    $.widget('mage.zoom', $.mage.zoom, {
        ...
        /**
         * Calculate large images offset depending on enabled "white borders" functionality.
         *
         * @return {Object}
         * @protected
         */
