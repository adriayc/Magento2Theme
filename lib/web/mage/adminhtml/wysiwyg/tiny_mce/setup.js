    ...
    tinyMceWysiwygSetup.prototype = {
        ...
        getSettings: function (mode) {
            ...
            settings = {
                ...
                'theme_advanced_buttons2': 'cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,images,cleanup,help,code,|,forecolor,backcolor', //eslint-disable-line max-len
