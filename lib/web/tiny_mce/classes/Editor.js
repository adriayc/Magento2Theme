...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		 ...
		 *          title : 'example.desc',
		 *          images : '../jscripts/tiny_mce/plugins/example/img/example.gif',
		 *          onclick : function() {
		...
		_addEvents : function() {
			...
			if (tinymce.isIE) {
				// Fix so resize will only update the width and height attributes not the styles of an images
				...
				dom.bind(t.getDoc(), 'controlselect', function(e) {
					...
					// Don't do this action for non images elements
					if (e.nodeName !== 'IMG')
						return;
