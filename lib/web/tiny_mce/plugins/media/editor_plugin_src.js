	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		init : function(ed, url) {
			...
			ed.onPreInit.add(function() {
				...
				// Convert video elements to images placeholder
				...
				// Convert images placeholders to video elements
		...
		/**
		 * Converts a tinymce.html.Node images element to video/object/embed.
		 */
		 ...
		 *
		 * The video/object/embed will be converted into an images placeholder with a JSON data attribute like this:
		...
		objectToImg : function(node) {
			...
			// Replace the video/object/embed element with a placeholder images containing the data
			node.replace(img);
