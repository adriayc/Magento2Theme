...
define([
    ...
    return function (config, element) {
        ...
        /**
         * Return width and height of original images
         * @param src path for original images
        ...
        /**
         * Sets min-height and min-width for images to avoid transition bug
         * @param $image - fullscreen images
         */
         ...
         * If images bigger than her wrapper. Zoom controls must visible.
         * @param path - images source path
         * @param $image
         */
        ...
        function magnifierFullscreen(fotorama) {
            ...
            /**
             * Sets images size to original or fit in parent block
