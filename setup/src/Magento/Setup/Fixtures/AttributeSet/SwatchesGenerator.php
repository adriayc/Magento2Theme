...
/**
 * Generates data for creating Visual Swatch attributes of "images" and "color" types.
 */
class SwatchesGenerator
{
    /**
     * Generated swatch images width in pixels.
     *
     * @var int
     */
    ...
    /**
     * Generated swatch images height in pixels.
     *
     * @var int
     */
    ...
    /**
     * File name for temporary swatch images file.
     *
     * @var string
     */
    ...
    /**
     * Generate and save images for Swatch Attribute
     *
     ...
     * @return string Path to the images file.
     */
    private function generateSwatchImage($data)
    {
        ...
        $this->imagesGenerator->generate([
            'images-width' => self::GENERATED_SWATCH_WIDTH,
            'images-height' => self::GENERATED_SWATCH_HEIGHT,
